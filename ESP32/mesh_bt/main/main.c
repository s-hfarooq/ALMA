...
#else /* ifdef CONFIG_EXAMPLE_A2DP_SINK_OUTPUT_INTERNAL_DAC */
    .mode                 = I2S_MODE_MASTER | I2S_MODE_TX, // Only TX
#endif /* ifdef CONFIG_EXAMPLE_A2DP_SINK_OUTPUT_INTERNAL_DAC */
    .sample_rate          = 44100,
    .bits_per_sample      = 16,
...
#endif /* if (CONFIG_BT_SSP_ENABLED == true) */
...
#else /* ifdef CONFIG_MESH_ENABLE_PS */

  /* Disable mesh PS function */
  ESP_ERROR_CHECK(esp_mesh_disable_ps());
  ESP_ERROR_CHECK(esp_mesh_set_ap_assoc_expire(10));
#endif /* ifdef CONFIG_MESH_ENABLE_PS */
